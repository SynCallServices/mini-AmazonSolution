...
extract-text-webpack-plugin@^3.0.0-beta.3:
  ...
  resolved "https://registry.yarnpkg.com/extract-text-webpack-plugin/-/extract-text-webpack-plugin-3.0.0-beta.3.tgz#9f0782076ac9b7c70ae6f32d3676af7a81df5e6a"
  dependencies:
    async "^2.4.1"
    loader-utils "^1.1.0"
    schema-utils "^0.3.0"
...
lodash@^4.14.0, lodash@^4.17.2, lodash@^4.2.0, lodash@^4.6.1:
  version "4.17.4"
